...
pub struct Cli {
    /// Path to settings.toml [default: settings.toml]. Omitted and absent
    /// there, the configuration is taken entirely from BESTIARIO__* ; named
    /// explicitly and absent, it is an error.
